...
struct MatrixMultiplicationTests {
    ...
    func evaluationKeyContainment() throws {
        try PrivateNearestNeighborSearchUtil.MatrixMultiplicationTests.evaluationKeyContainment(for: NoOpScheme.self)
        try PrivateNearestNeighborSearchUtil.MatrixMultiplicationTests.evaluationKeyContainment(for: Bfv<UInt32>.self)
        try PrivateNearestNeighborSearchUtil.MatrixMultiplicationTests.evaluationKeyContainment(for: Bfv<UInt64>.self)
    }
}
