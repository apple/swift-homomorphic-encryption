...
struct HeAPITests {
    ...
    func testNoOpScheme() async throws {
        ...
        try await HeAPITestHelpers.schemeEncryptZeroMultiplyDecryptTest(context: context)
        ...
        try await HeAPITestHelpers.schemeCiphertextMultiplyAddPlainTest(context: context)
